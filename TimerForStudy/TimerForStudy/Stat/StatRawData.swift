...
private func createMockObject() -> Stat {
    ...
    let stat = Stat("Yeolmok", monthlyData, [friendData_1, friendData_2, friendData_3])
    return stat
}

private func createMonthlyData_friend_1() -> [Monthly] {
    // 2022년 9월 데이터
...
func createMonthlyData_friend_3() -> [Monthly] {
    // 2022년 10월 데이터
    let toeicData_10_1 = Category(name: "토익", time: 2000)
    let mathData_10_1 = Category(name: "수학", time: 3000)
    let programmingDate_10_1 = Category(name: "프로그래밍", time: 9500)
    let dailyData_10_1 = Daily(DateConverter.dayFormatter.date(from: "2022.10.01")!, [toeicData_10_1, mathData_10_1, programmingDate_10_1])
    ...
    // 2022년 12월 데이터
    let toeicData_12_1 = Category(name: "토익", time: 3600)
    let mathData_12_1 = Category(name: "수학", time: 12000)
    let programmingDate_12_1 = Category(name: "프로그래밍", time: 5000)
    let dailyData_12_1 = Daily(DateConverter.dayFormatter.date(from: "2022.12.01")!, [toeicData_12_1, mathData_12_1, programmingDate_12_1])
    
    let toeicData_12_2 = Category(name: "토익", time: 10000)
    let mathData_12_2 = Category(name: "수학", time: 8000)
    let programmingDate_12_2 = Category(name: "프로그래밍", time: 1000)
    let dailyData_12_2 = Daily(DateConverter.dayFormatter.date(from: "2022.12.02")!, [toeicData_12_2, mathData_12_2, programmingDate_12_2])
    ...
    let programmingData_1_5 = Category(name: "프로그래밍", time: 9000)
    let algorithmData_1_5 = Category(name: "알고리즘", time: 10000)
    let operatingSystemData_1_5 = Category(name: "운영체제", time: 3000)
    let interviewData_1_5 = Category(name: "면접", time: 7200)
    let dailyData_1_5 = Daily(DateConverter.dayFormatter.date(from: "2023.01.05")!, [programmingData_1_5, algorithmData_1_5, operatingSystemData_1_5, interviewData_1_5])
    
    let monthlyData_1 = Monthly(DateConverter.monthFormatter.date(from: "2023.01")!, [dailyData_1_1, dailyData_1_2, dailyData_1_5])
    
    let monthlyData = [monthlyData_10, monthlyData_11, monthlyData_12, monthlyData_1]
    return monthlyData
}

let monthlyData_friend_1 = createMonthlyData_friend_1()
let monthlyData_friend_3 = createMonthlyData_friend_3()
let friendData_1 = Friend(name: "정도연", image: Image("User1"), monthlyData_friend_1, isAccessEnabled: true, isPeeping: true)
let friendData_2 = Friend(name: "김동욱", image: Image("User2"), isAccessEnabled: false, isPeeping: false)
let friendData_3 = Friend(name: "유준용", image: Image("User3"), monthlyData_friend_3, isAccessEnabled: true, isPeeping: true)
